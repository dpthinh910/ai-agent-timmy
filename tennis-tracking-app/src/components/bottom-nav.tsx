...
import { Home, Users, PlayCircle, Receipt, Wrench, Settings } from 'lucide-react';
...
const tabs = [
  ...
  { id: 'gear' as const, label: 'Gear', icon: Wrench },
        ...
        {tabs.map(({ id, label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className={`group flex flex-1 flex-col items-center gap-0.5 rounded-xl px-1 py-1.5 transition-all duration-200 ${
                isActive
                  ? 'text-emerald-500'
